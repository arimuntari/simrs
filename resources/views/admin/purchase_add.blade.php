...
<div class="container">
  ...
  <fieldset>
    ...
    <form  action="{{ route('purchase.store') }}" autocomplete="off" method="post" enctype="multipart/form-data">
      @csrf
    <div class="table table-responsive mt-3" style="margin-bottom: 0px;">
      <table class="table table-bordered" style="margin-bottom: 0px;">
        ...
        <tr bgcolor="#ccc">
            ...
            <td>:</td>
            <td><input type="text" name="code" class="form-control input-xs" style="width:auto" value="{{ Helper::codePurchase() }}"></td>
            <td width:150px>Tanggal</td>
            <td>:</td>
            <td><input type="text" name="purchase_date" class="form-control input-xs datepicker" style="width:auto" value="{{ date('Y-m-d') }}"></td>
        </tr>
      </table>
    </div>
	  <div class="table table-responsive">
        ...
        <tr>
          ...
          <th width="100px"><input type="text" class="form-control input-xs" onkeyup="checkAmount();" id="price" name="price" style="width:100%;"></th>
...
<script>
      ...
      processResults: function (data) {
        return {
          results:  $.map(data, function (item) {
            return {
              text: item.code+" | "+item.name+" | "+item.stock+" | "+item.purchase_price,
              code: item.code,
              stock: item.stock,
  ...
  function saveitem(){
    ...
    if(data == ''){
      ...
      data = { medicine_id :medicine_id, amount : amount , price : price };
      $.ajax({
        url: "saveitem",
        data: data,
